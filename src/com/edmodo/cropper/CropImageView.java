...
public class CropImageView extends FrameLayout {
    ...
    /**
     * Sets a Bitmap as the content of the CropImageView & set the crop window frame bitmap.
     * 
     * @param bitmap the Bitmap to set
     */
    public void setImageBitmapWithFrame(Bitmap bitmap,Bitmap frameImage) {
        ...
        if (mCropOverlayView != null) {
        	mCropOverlayView.setFrameBitmap(frameImage);
            mCropOverlayView.resetCropOverlayView();
        }
    }
    ...
    public Bitmap getCroppedImage() {
        ...
        //return getCropedImageWithFrame(croppedBitmap, mFrameImage);
