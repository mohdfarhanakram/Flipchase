...
public class FlipViewController extends AdapterView<Adapter> {
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    if (FlipBookLog.ENABLE_DEBUG) {
      FlipBookLog.d("onLayout: %d, %d, %d, %d; child %d", l, t, r, b, bufferedViews.size());
    }
  ...
  private void debugBufferedViews() {
    if (FlipBookLog.ENABLE_DEBUG) {
      FlipBookLog.d("bufferedViews: %s; buffer index %d, adapter index %d", bufferedViews, bufferIndex,
                 adapterIndex);
    }
  }
  ...
  void flippedToView(final int indexInAdapter, boolean isPost) {
    if (FlipBookLog.ENABLE_DEBUG) {
      FlipBookLog.d("flippedToView: %d, isPost %s", indexInAdapter, isPost);
    }
