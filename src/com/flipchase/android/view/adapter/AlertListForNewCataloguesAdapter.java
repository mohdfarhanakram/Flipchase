...
public class AlertListForNewCataloguesAdapter extends BaseAdapter {
     ...
     * @param context
     */
    public AlertListForNewCataloguesAdapter(Activity context) {
        inflater = LayoutInflater.from(context);
        mContext = context;
    }

    public AlertListForNewCataloguesAdapter(Activity context, List<CatalogueDisplay> list) {
    	inflater = LayoutInflater.from(context);
        mContext = context;
        this.items = list;
	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CatalogueDisplay itemDetail = items.get(position);
        holder.storeTitle.setText(itemDetail.getCatalogue().getName());
        return row;
    }
